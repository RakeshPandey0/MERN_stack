...
function App() {
  ...
  return (
    <>
      <h1>TODO</h1>
      <TodoForm handleSubmit={handleSubmit} newTodo={newTodo} handleChange={handleChange} indexToBeEdited={indexToBeEdited} />
        ...
        {todos.map((todo, index) => {
          return (
            <li key={index}>
              ...
              <Button label="Edit" onClick={()=>handleEdit(index)} color="error"/>
            </li>
          );
        })}
      </ul>
